...
def get_config(config_section=watchdog.CONFIG_SECTION, config_item=None, config_item_value=None):
    try:
...
def test_is_instance_metadata_url_helper():
    ...
    assert True == watchdog.is_instance_metadata_url(mount_efs.INSTANCE_METADATA_TOKEN_URL)
    assert True == watchdog.is_instance_metadata_url(mount_efs.INSTANCE_METADATA_SERVICE_URL)
...
def _test_get_boolean_config_item_in_config_file_helper(config, config_section, config_item, default_value, expected_value):
    assert expected_value == watchdog.get_boolean_config_item_value(config, config_section, config_item, default_value)
...
def test_get_true_boolean_config_item_in_config_file():
    ...
    assert True == watchdog.get_boolean_config_item_value(config, config_section, config_item, False)
...
def test_get_false_boolean_config_item_in_config_file():
    ...
    assert False == watchdog.get_boolean_config_item_value(config, config_section, config_item, True)
