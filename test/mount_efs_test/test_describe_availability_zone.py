...
def test_describe_availability_zones_dryrun_succeed_return_correct(mocker):
    ...
    _test_describe_availability_zones_response(mocker, ClientError(dryrun_exception_response, OPERATION_NAME), response, 2, AZ_ID)
...
def test_describe_availability_zones_dryrun_failed_unauthorized_operation(mocker):
    ...
    _test_describe_availability_zones_response(mocker, ClientError(dryrun_exception_response, OPERATION_NAME), None, 1,
...
def test_describe_availability_zones_dryrun_failed_no_credential_error(mocker):
    _test_describe_availability_zones_response(mocker, NoCredentialsError(), None, 1,
                                               desired_exception=mount_efs.FallbackException,
...
def test_describe_availability_zones_failed_unknown_error(mocker):
    _test_describe_availability_zones_response(mocker, Exception('Unknown'), None, 1,
                                               desired_exception=mount_efs.FallbackException,
                                               desired_message='Unknown error')


def test_describe_availability_zones_failed_endpoing_error(mocker):
    _test_describe_availability_zones_response(mocker, EndpointConnectionError(endpoint_url='https://efs.us-east-1.com'), None, 1,
                                               desired_exception=mount_efs.FallbackException,
...
def test_describe_availability_zones_return_empty_az_info(mocker):
    ...
    _test_describe_availability_zones_response(mocker, ClientError(dryrun_exception_response, OPERATION_NAME), response, 2, None)
...
def test_describe_availability_zones_return_none_az_info(mocker):
    ...
    _test_describe_availability_zones_response(mocker, ClientError(dryrun_exception_response, OPERATION_NAME), None, 2, None)
